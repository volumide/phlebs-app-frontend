<template>
  <div class="innner_ come-up">
    <p class="title">
      You can now reset your Password
    </p>
    <p class="sub-title">
      Enter a minimum of 6 Characters to create a new Password.
    </p>
    <p class="sub-title">
      Password sould contain a at least One UPPERCASE, one symbol and one Number
    </p>
    <div class="form">
      <div v-if="error">
