...
export default {
  ...
  methods: {
    ...
    selectCVfile (event) {
      ...
      // if (CVfileId.type !== 'image/jpeg' || CVfileId.type !== 'image/png') {
      //   this.inputCVfile = []
    ...
    selectLicencefile (event) {
      ...
      // if (LicencefileId.type !== 'image/jpeg' || LicencefileId.type !== 'image/png') {
      //   this.inputLicencefile = []
      //   this.$toasted.error('Enter a valid file type')
      // } else {
      //   this.inputLicencefile = LicencefileId
      // }
    ...
    selectSupportingfile (event) {
      ...
      // if (SupportingfileId.type !== 'image/jpeg' || SupportingfileId.type !== 'image/png') {
      //   this.inputSupportingfile = []
      //   this.$toasted.error('Enter a valid file type')
      // } else {
      //   this.inputSupportingfile = SupportingfileId
      // }
