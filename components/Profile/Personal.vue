<template>
  <div class="personal_ctn">
      ...
      <div class="rhs">
        <div>
          <div class="input_cont">
            ...
            <div class="new_input">
              <input v-model="proficiency" type="text">
              <svg
                v-if="allowEdit"
                width="12"
                height="12"
    ...
    <div class="bottom_btn slide-in-from-left">
      <button v-if="allowEdit" class="bg_btn" @click="requestEdit = true">
        Update Changes
      </button>
...
export default {
  data () {
    return {
      proficiency: 'Phlebotomist',
      address: '42, Sola Chinyere Crescent, Ketu, Lagos',
      gender: 'Female',
      dropoff: 'Medplus, Alapere Ketu',
      allowEdit: false,
      requestEdit: false,
      successModal: false,
      userImage: null,
