  ...
  <div>
    ...
    <div v-else>
      <div v-if="tableData.length">
              ...
              <td class="action-ctn">
                <div class="action">
                  <svg
                    ...
                    @click="$router.push('/today-order/details')"
                  >
        ...
        <div class="no_show">
          <div v-for="(data, index) in tableData" :key="index" class="data_box slide-in-from-left" @click="$router.push('/today-order/details')">
            <div>
              <p class="mobile_time">
                {{ data[0].collectionTime }}
              </p>
