  ...
  <div class="main_container">
    <div class="header-container">
      ...
      <div class="last-section">
        <div class="new_input">
          <input type="search" name="search" autocomplete="off" placeholder="Search for Name, Order Reference No">
        ...
        <div class="notification" @click="$emit('openNotification')">
          <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <circle v-if="notificationsCount > 0" cx="24.5" cy="10.5" r="4.5" fill="#F44336" />
            <defs>
