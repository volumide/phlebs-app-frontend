...
export const detailedDate = value => value ? moment(String(value)).format('dddd, Do MMMM YYYY.') : '_ _'
export const semidetailedDate = value => value ? moment(String(value)).format('Do MMMM YYYY.') : '_ _'
export const dateInFull = value => value ? moment(String(value)).format('Do MMMM, YYYY., hh:mm:ss a') : '_ _'
export const completeDateInFull = value => value ? moment(String(value)).format('dddd, Do MMMM, YYYY. hh:mm a') : '_ _'
