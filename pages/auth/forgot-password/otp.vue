  ...
  <div class="container">
    <div class="inner">
      <div class="lhs">
        ...
        <!-- <div v-if="resetPassword" class="inner_">
          <ModalsResetPassword />
        </div>
      ...
      <div class="rhs">
        <div class="rhs_inner">
          <div class="top_btn">
            <button v-if="SuccessPage" class="trans_btn" @click="$router.push('/auth/login')">
              Login
            </button>
            <button v-else class="trans_btn" @click="$router.go(-1)">
              Back
            </button>
          </div>
          ...
          <div v-else class="inner_">
            ...
            <ModalsResetPassword v-if="resetPassword" :code="code" @close-reset="resetPassword = false; SuccessPage = true" />
            <ModalsOtp v-else @closeOtp="resetPassword = true" @getCode="getCode" />
          </div>
        </div>
      </div>
    </div>
